...
namespace CodeCodeChallenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        #region Employee Reporting endpoints
        [TestMethod]
        public void GetReportingStructure_Returns_Ok_With_Four_Reports_Stemming_From_Multiple_Employees()
        {
            // Arrange
            var employeeId = "16a596ae-edd3-4847-99fe-c4518e82c86f";
        ...
        [TestMethod]
        public void GetReportingStructure_Returns_Ok_With_Two_Reports_Stemming_From_One_Employee()
        {
            // Arrange
        ...
        [TestMethod]
        public void GetReportingStructure_Returns_Ok_With_No_Reports()
        {
            // Arrange
